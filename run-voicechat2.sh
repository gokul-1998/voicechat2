...
LLM_CONTEXT=8192 # If you use Llama 3.1 and don't specify this it'll OOM (Out of Memory)
...
# Check if mamba/conda is initialized for the current shell
if ! mamba shell hook --shell bash &> /dev/null; then
